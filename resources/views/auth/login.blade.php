            ...
            <div class="row g-0">
              ...
              >
                <div style="max-width: 25rem">
                  ...
                  <div class="mb-6">
                    <h1 class="color-900 text-info ">
                      Welcome Our  Inventory Management System
                    </h1>
                  </div>
                  <!-- Image block -->
                  <div class="">
              ...
              >
                <div
                  class="w-100 p-3 p-md-5 card border-0 shadow-sm"
                  style="max-width: 32rem;background-color: slategrey;"
                >
                  <!-- Form -->
                  <form class="row g-1 p-3 p-md-4" method="POST" action="{{route('login')}}">
                      ...
                      <a class="btn btn-lg btn-light btn-block" href="#">
                        ...
                        >
                          <img
                            ...
                            src="{{asset('admin/images/google.svg')}}"
                    ...
                    <div class="col-12 text-center mt-4">
                     ...
                     <button class="btn btn-lg btn-block btn-light lift text-uppercase" type="submit"> SING IN</button>
                    </div>
                    <div class="col-12 text-center mt-4">
                      <span
                        >Don't have an account yet?
                        <a href="auth-signup.html" class="text-secondary"
                          >Sign up here</a
                        ></span
                      >
                    </div>
